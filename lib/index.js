...
function bundle(lambdaPackagePath, outputZip) {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve) {
                    ...
                    output.on('close', function () {
                        ...
                        var params = Object.entries(lambdaConfig).filter(function (_a) {
                            var entryName = _a[0];
                            return !['dependencies'].includes(entryName);
                        }).map(function (_a) {
                        ...
                        var execCmd = "aws lambda update-function-code --zip-file fileb://" + zipPathDst.replace(/\\/g, '/') + " " + params;
